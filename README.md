...
1.  **Requirements**: Python 3.8+, an ESP32, and an analog instrumentation circuit.
2.  **Install Dependencies**:
    ```bash
    pip install numpy scipy matplotlib pyserial Pillow
    ```
3.  **Upload Firmware**: Flash the code provided in the `/firmware` folder to your ESP32.
4.  **Run Interface**:
    ```bash
...
### About the Author
**José Luis Valencia Rivera** *Biomedical Engineer | Software Developer | Digital Systems Specialist* Specialized in hardware-software integration for the clinical sector and medical signal acquisition.

### 📩 Contact & Professional Links
**LinkedIn**: [linkedin.com/in/jose-luis-valencia-rivera](www.linkedin.com/in/jose-luis-valencia-rivera)

**Email**: [valencia.rivera.jose.luis@gmail.com](mailto:valencia.rivera.jose.luis@gmail.com)

**Portfolio/GitHub**: [github.com/Cogito-ergo-sum25](https://github.com/Cogito-ergo-sum25)
